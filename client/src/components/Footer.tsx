    ...
    <div>
      <footer className="w-full py-14">
        <a href="/" className="flex items-center justify-center space-x-2">
          ...
          <div className="text-2xl font-bold">Jackson's movie app</div>
        </a>

        <ul className="text-lg flex  justify-center flex-col gap-7 md:flex-row md:gap-8 transition-all duration-500 py-8 mb-8 border-b border-gray-200">
          <li>
